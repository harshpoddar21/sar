...
ActiveRecord::Schema.define(version: 20170725122530) do
  ...
  create_table "auto_bookings", force: :cascade do |t|
  ...
  create_table "dead_between_points", force: :cascade do |t|
    t.text     "start_point",    limit: 65535
  ...
  create_table "rms_routes", force: :cascade do |t|
    t.integer  "route_id",           limit: 4
    t.text     "name",               limit: 65535
    t.integer  "is_b2b",             limit: 4
    t.integer  "reverse_route_id",   limit: 4
    t.integer  "start_time_in_secs", limit: 4
    ...
    t.text     "end_location",       limit: 65535
    t.datetime "created_at",                       null: false
    t.datetime "updated_at",                       null: false
  end
  ...
  create_table "route_dead_time_and_distances", force: :cascade do |t|
    t.integer  "route_id_1", limit: 4
    t.integer  "route_id_2", limit: 4
    t.integer  "distance",   limit: 4
    t.integer  "time",       limit: 4
    t.integer  "dep_time",   limit: 4
    t.datetime "created_at",           null: false
    t.datetime "updated_at",           null: false
  end
