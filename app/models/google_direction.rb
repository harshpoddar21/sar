class GoogleDirection
  ...
  GOOGLE_BASE_URL="https://maps.googleapis.com/maps/api/directions/json?sensor=false&units=metric&mode=driving&key=AIzaSyAeOKzRCXsIc9oGhx7cbmpPw9JGL6tpR4k&departure_time="
