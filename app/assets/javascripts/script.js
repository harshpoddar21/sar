...
function switchScreen(scrno, obj){
	switch(scrno){
		...
		case 4:
			...
			html += '<div class="modal-body text-center"><input class="col-md-12" type="number" maxlength="10" id="userPhoneNumber" onKeyup="validatePhone()" /><p class="error"></p><div class="loader"><img src="resources/images/rolling.gif" /></div><div class="bounce">I\'m not interested</div></div>';
			html += '</div></div></div>';
			$('#phoneModal .error').html('').hide();
			$(obj).html(html)
				.find('.downArr').hide().end()
