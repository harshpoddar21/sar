! function t(e, n, r) {
    ...
    6: [function(t, e, n) {
        (function(e, r) {
            ...
            function l(t, e, n, r, i) {
                for (var o = [], s = 0, a = e.length; a > s; ++s) R(e, String(s)) ? o.push(p(t, e, n, r, String(s), !0)) : o.push("");
            ...
            function p(t, e, n, r, i, o) {
                ...
                if (c = Object.getOwnPropertyDescriptor(e, i) || {
                            value: e[i]
                        }, c.get ? a = c.set ? t.stylize("[Getter/Setter]", "special") : t.stylize("[Getter]", "special") : c.set && (a = t.stylize("[Setter]", "special")), R(r, i) || (s = "[" + i + "]"), a || (t.seen.indexOf(c.value) < 0 ? (a = m(n) ? u(t, c.value, null) : u(t, c.value, n - 1), a.indexOf("\n") > -1 && (a = o ? a.split("\n").map(function(t) {
                        return "  " + t
                    }).join("\n").substr(2) : "\n" + a.split("\n").map(function(t) {
                        return "   " + t
            ...
            n.debuglog = function(t) {
                if (w(D) && (D = e.env.NODE_DEBUG || ""), t = t.toUpperCase(), !N[t])
                ...
                date: "magenta",
                regexp: "red"
            }, n.isArray = h, n.isBoolean = y, n.isNull = m, n.isNullOrUndefined = g, n.isNumber = v, n.isString = b, n.isSymbol = _, n.isUndefined = w, n.isRegExp = x, n.isObject = E, n.isDate = j, n.isError = T, n.isFunction = A, n.isPrimitive = I, n.isBuffer = t("./support/isBuffer");
    ...
    7: [function(t, e, n) {
        function r(t, e, n) {
            ...
            function l() {
                if (p = arguments, y = c(), m = this, v = w && (g || !x), _ === !1) var n = x && !g;
                else {
                    d || x || (b = y);
                    var r = _ - (y - b),
                        i = 0 >= r || r > _;
    ...
    10: [function(t, e, n) {
        ...
        function s(t, e, n, r, i, o, s) {
            ...
            if (!i) {
                var x = v && j.call(t, "__wrapped__"),
                    E = b && j.call(e, "__wrapped__");
                if (x || E) return n(x ? t.value() : t, E ? e.value() : e, r, i, o, s)
            }
            if (!w) return !1;
            o || (o = []), s || (s = []);
            for (var A = o.length; A--;)
                if (o[A] == t) return s[A] == e;
            o.push(t), s.push(e);
            var I = (f ? a : c)(t, e, n, r, i, o, s);
            return o.pop(), s.pop(), I
        }
    ...
    12: [function(t, e, n) {
        ...
        function o(t) {
            return r(t) && i(t.length) && !!S[R.call(t)]
        }
        var s = "[object Arguments]",
            ...
            S = {};
        S[_] = S[w] = S[x] = S[E] = S[j] = S[T] = S[A] = S[I] = S[O] = !0, S[s] = S[a] = S[b] = S[u] = S[c] = S[f] = S[l] = S[p] = S[d] = S[h] = S[y] = S[m] = S[g] = S[v] = !1;
    ...
    17: [function(t, e, n) {
        ...
        function u(t) {
            return i(t) && "string" == typeof t.message && O.call(t) == v
        }

        function c(t, e, n) {
            var i = g.imports._.templateSettings || g;
            n && d(t, e, n) && (e = n = void 0), t = l(t), e = s(a({}, n || e), i, o);
            var c, f, m = s(a({}, e.imports), i.imports, o),
                v = y(m),
                T = p(m, v),
                A = 0,
                I = e.interpolate || E,
                O = "__p += '",
                k = RegExp((e.escape || E).source + "|" + I.source + "|" + (I === h ? x : E).source + "|" + (e.evaluate || E).source + "|$", "g"),
                R = "sourceURL" in e ? "//# sourceURL=" + e.sourceURL + "\n" : "";
            t.replace(k, function(e, n, i, o, s, a) {
                return i || (i = o), O += t.slice(A, a).replace(j, r), n && (c = !0, O += "' +\n__e(" + n + ") +\n'"), s && (f = !0, O += "';\n" + s + ";\n__p += '"), i && (O += "' +\n((__t = (" + i + ")) == null ? '' : __t) +\n'"), A = a + e.length, e
            }), O += "';\n";
            var P = e.variable;
            P || (O = "with (obj) {\n" + O + "\n}\n"), O = (f ? O.replace(b, "") : O).replace(_, "$1").replace(w, "$1;"), O = "function(" + (P || "obj") + ") {\n" + (P ? "" : "obj || (obj = {});\n") + "var __t, __p = ''" + (c ? ", __e = _.escape" : "") + (f ? ", __j = Array.prototype.join;\nfunction print() { __p += __j.call(arguments, '') }\n" : ";\n") + O + "return __p\n}";
            var D = S(function() {
                return Function(v, R + "return " + O).apply(void 0, T)
            });
            if (D.source = O, u(D)) throw D;
            return D
        }
        var f = t("lodash._basecopy"),
            l = t("lodash._basetostring"),
            p = t("lodash._basevalues"),
            d = t("lodash._isiterateecall"),
            h = t("lodash._reinterpolate"),
            y = t("lodash.keys"),
            m = t("lodash.restparam"),
            g = t("lodash.templatesettings"),
            v = "[object Error]",
            b = /\b__p \+= '';/g,
            _ = /\b(__p \+=) '' \+/g,
            w = /(__e\(.*?\)|\b__t\)) \+\n'';/g,
    ...
    33: [function(t, e, n) {
        ...
        e.exports = function(e) {
            ...
            }).wrap(t("rest/interceptor/template")).wrap(i)
        }
    }, {
        "./callbackify": 32,
        rest: 50,
    ...
    36: [function(t, e, n) {
        (function(n) {
            ...
            function r(t) {
                var e = t.split(".")[1];
                if (!e) return null;
                if (e = e.replace(/-/g, "+").replace(/_/g, "/"), n.browser) e = e.replace(/=/g, "");
                else {
                    var r = e.length % 4;
    ...
    38: [function(t, e, n) {
        "use strict";
        var r = t("./make_service"),
            i = t("xtend/mutable"),
            o = t("./services/geocoder"),
            s = t("./services/surface"),
            a = t("./services/directions"),
            u = t("./services/uploads"),
            c = t("./services/matching"),
            f = t("./services/datasets"),
            l = t("./services/distance"),
            p = t("./services/tilestats"),
            d = r("MapboxClient");
    ...
    39: [function(t, e, n) {
        "use strict";
        var r = t("assert"),
            i = t("geojsonhint/object"),
            o = t("hat"),
            s = t("../make_service"),
            a = t("../constants"),
            u = e.exports = s("MapboxDatasets");
    ...
    42: [function(t, e, n) {
        ...
        a.prototype.geocodeForward = function(t, e, n) {
            ...
            e.precision && (i("number" == typeof e.precision, "precision option must be number"), a = e.precision), this.client({
                ...
                params: {
                    longitude: r(t.longitude, a),
                    latitude: r(t.latitude, a),
                    dataset: o
                },
                callback: n
            })
            ...
            function a(t) {
                if (t.crs)
                    if ("object" == typeof t.crs) {
                        var e = r(t.crs, "type", "string"),
                            n = r(t.crs, "properties", "object");
                        ...
                        function(e, n) {
                            function r(t) {
                                ...
                                return s = {}, a = {
                                    ...
                                    path: t
                                } : t || {}, t.originator = t.originator || r, c(u.call(s, t, n, a), function(t) {
                                    var r, u, c;
                                ...
                                return i.findProperties(t, "_embedded", function(t, n, r) {
                                    ...
                                    Object.keys(t).forEach(function(n) {
                                        ...
                                        n in i || e(i, n, s.make(o(function() {
                                            return a.deprecation && c(n, a.deprecation), a.templated === !0 ? r(f)({
                                                path: a.href
                                            }) : f({
                                                path: a.href
                                            })
                                        ...
                                        return o.deprecation && c(e, o.deprecation), o.templated === !0 ? r(i || f, {
                                            template: o.href
                                        }) : n(i || f, {
                                            prefix: o.href
                                        })
            ...
            t(function(t) {
                ...
                return function(t) {
                    function r(e) {
                        ...
                        for (var i, o, s = t._defer(), a = s._handler, u = e.length >>> 0, c = u, f = [], l = 0; u > l; ++l)
                            if (o = e[l], void 0 !== o || l in e) {
            ...
            ! function(e) {
                ...
                e(function() {
                    return function(e) {
                        ...
                        function g(t) {
                            return C(t) ? t._handler.join() : M(t) ? b(t) : new T(t)
                        }
                        ...
                        function j(t, e) {
                            x.call(this), V.enqueue(new P(t, e, this))
                        }
                        ...
                        }, n.all = c, n.race = y, n._traverse = f, n._visitRemaining = d, _.prototype.when = _.prototype.become = _.prototype.notify = _.prototype.fail = _.prototype._unreport = _.prototype._report = B, _.prototype._state = 0, _.prototype.state = function() {
                            return this._state
                        ...
                        H(_, x), x.prototype._state = 0, x.prototype.resolve = function(t) {
                            ...
                            for (var t = this; void 0 !== t.handler;)
                                if (t = t.handler, t === this) return this.handler = S();
                            return t
                            ...
                            this.resolved || (this.resolved = !0, this.handler = t, void 0 !== this.consumers && V.enqueue(this), void 0 !== this.context && t._report(this.context))
                        }, x.prototype.when = function(t) {
                            this.resolved ? V.enqueue(new k(t, this.handler)) : void 0 === this.consumers ? this.consumers = [t] : this.consumers.push(t)
                        }, x.prototype.notify = function(t) {
                            this.resolved || V.enqueue(new R(t, this))
                        ...
                        H(_, A), A.prototype._state = -1, A.prototype.fold = function(t, e, n, r) {
                            ...
                            V.afterQueue(new I(this, t))
                        }, A.prototype._unreport = function() {
                            this.handled || (this.handled = !0, V.afterQueue(new O(this)))
                        }, A.prototype.fail = function(t) {
                            this.reported = !0, J("unhandledRejection", this), n.onFatalRejection(this, void 0 === t ? this.context : t)
                        }, I.prototype.run = function() {
                            this.rejection.handled || this.rejection.reported || (this.rejection.reported = !0, J("unhandledRejection", this.rejection) || n.onPotentiallyUnhandledRejection(this.rejection, this.context))
                        }, O.prototype.run = function() {
                            this.rejection.reported && (J("rejectionHandled", this.rejection) || n.onPotentiallyUnhandledRejectionHandled(this.rejection))
                        ...
                        return k.prototype.run = function() {
                            ...
                            if (void 0 !== t)
                                for (var e, n = 0; n < t.length; ++n) e = t[n], q(e.progress, this.value, this.handler, e.receiver, e.resolver)
                            ...
                            var r = this.resolver;
                            D(this._then, this.thenable, t, e, n)
                        }, N.prototype.fulfilled = function(t) {
                            this.f.call(this.c, this.z, t, this.to)
                        }, N.prototype.rejected = function(t) {
                            this.to.reject(t)
    ...
    84: [function(t, e, n) {
        ! function(t) {
            ...
            t(function(t) {
                ...
                var d = t("./lib/decorators/timed"),
                    h = t("./lib/decorators/array"),
                    y = t("./lib/decorators/flow"),
                    m = t("./lib/decorators/fold"),
                    g = t("./lib/decorators/inspect"),
                    v = t("./lib/decorators/iterate"),
                    b = t("./lib/decorators/progress"),
                    _ = t("./lib/decorators/with"),
                    w = t("./lib/decorators/unhandledRejection"),
                    x = t("./lib/TimeoutError"),
                    E = [h, y, m, v, b, g, _, d, w].reduce(function(t, e) {
                        return e(t)
                    }, t("./lib/Promise")),
                    j = t("./lib/apply")(E);
    ...
    96: [function(t, e, n) {
        ...
        var i = t("./createStore"),
            o = r(i),
            s = t("./utils/combineReducers"),
            a = r(s),
            u = t("./utils/bindActionCreators"),
            c = r(u),
            f = t("./utils/applyMiddleware"),
            l = r(f),
            p = t("./utils/compose"),
            d = r(p);
            ...
            return function(t) {
                return function(n, r) {
                    ...
                    return u = e.map(function(t) {
                        return t(c)
                    }), s = a["default"].apply(void 0, u.concat([i.dispatch])), o({}, i, {
                        dispatch: s
                    })
                }
            }
    ...
    106: [function(t, e, n) {
        ...
        r.prototype.show = function() {
            ...
            e && (n.className += " active"), r.innerHTML = this.component.highlight(t), n.appendChild(r), this.element.appendChild(n), n.addEventListener("mousedown", function() {
                this.handleMouseDown.call(this, t)
            }.bind(this))
        }, r.prototype.handleMouseDown = function(t) {
            this.component.value(t), this.clear(), this.draw()
    ...
    107: [function(t, e, n) {
        ...
        var r = t("xtend"),
            ...
            o = function(t, e, n) {
                return n = n || {}, this.options = r({
                    minLength: 2,
                    limit: 5
                }, n), this.el = t, this.data = e || [], this.list = new i(this), this.query = "", this.selected = null, this.list.draw(), this.el.addEventListener("keyup", function(t) {
                    this.handleKeyUp.call(this, t.keyCode)
                }.bind(this), !1), this.el.addEventListener("keydown", function(t) {
                    this.handleKeyDown.call(this, t)
        ...
        o.prototype.handleKeyUp = function(t) {
            ...
            switch (t.keyCode) {
                case 13:
                case 9:
                    this.list.isEmpty() || (this.value(this.list.items[this.list.active]), this.list.hide());
                    break;
                case 27:
            ...
            for (var e = [], n = 0; n < this.data.length; n++) {
                var r = this.getItemValue(this.data[n]);
                this.match(this.normalize(r), this.query) && e.push(this.data[n])
            }
            t(e)
        }, o.prototype.getItemValue = function(t) {
            return t
        }, o.prototype.highlight = function(t) {
            return this.getItemValue(t).replace(new RegExp(this.query, "ig"), function(t) {
    ...
    109: [function(t, e, n) {
        function r(t, e, n) {
            var r, i, o, s, a, u, c, f, p, d = 0,
                h = "FeatureCollection" === t.type,
                y = "Feature" === t.type,
                m = h ? t.features.length : 1;
            for (r = 0; m > r; r++)
                for (f = h ? t.features[r].geometry : y ? t.geometry : t, p = "GeometryCollection" === f.type, u = p ? f.geometries.length : 1, s = 0; u > s; s++)
                    if (a = p ? f.geometries[s] : f, c = a.coordinates, d = !n || "Polygon" !== a.type && "MultiPolygon" !== a.type ? 0 : 1, "Point" === a.type) e(c);
                    else if ("LineString" === a.type || "MultiPoint" === a.type)
                        for (i = 0; i < c.length; i++) e(c[i]);
                    else if ("Polygon" === a.type || "MultiLineString" === a.type)
                        for (i = 0; i < c.length; i++)
                            for (o = 0; o < c[i].length - d; o++) e(c[i][o]);
                    else {
                        if ("MultiPolygon" !== a.type) throw new Error("Unknown Geometry Type");
                        for (i = 0; i < c.length; i++)
                            for (o = 0; o < c[i].length; o++)
                                for (l = 0; l < c[i][o].length - d; l++) e(c[i][o][l])
                    }
        }
    ...
    110: [function(t, e, n) {
        ...
        function d(t, e) {
            return function(n, r) {
                ...
                return Q.geocodeForward(t.trim(), s, function(t, r) {
                    if (t) throw t;
                    return r.error ? n(v(r.error)) : (n(v(null)), n(e(r.features)))
                })
            }
        }
        ...
        function h(t, e) {
            return function(n, r) {
                var i = r(),
                    a = i.routeIndex;
                return Q.getDirections(t, {
                    profile: "mapbox." + e,
                    geometry: "polyline"
                }, function(t, e) {
                    if (t) throw t;
                    return e.error ? n(v(e.error)) : (n(v(null)), e.routes[a] || n(E(0)), n(c(e.routes)), n(o(L(e.origin, {
                        properties: {
                            id: "origin",
                            "marker-symbol": "A"
                        }
                    }))), void n(s(L(e.destination, {
                        properties: {
                            id: "destination",
                            "marker-symbol": "B"
                        }
        ...
        function m(t) {
            ...
            return L(t, {
                properties: t.properties ? L(t.properties, e) : e
            })
        }
        ...
        function O(t) {
            return function(e) {
                return e(g("ORIGIN", !0)), e(d(t, function(n) {
                    return e(g("ORIGIN", !1)), e(a(t, n))
                }))
            }
        }
        ...
        function S(t) {
            return function(e) {
                return e(g("DESTINATION", !0)), e(d(t, function(n) {
                    return e(g("DESTINATION", !1)), e(u(t, n))
                }))
            }
        }
        ...
        function k(t) {
            return function(e) {
                var n = "string" == typeof t ? t : t.join();
                return e(g("ORIGIN", !0)), e(d(n, function(t) {
                    if (e(g("ORIGIN", !1)), t.length) {
                        var n = t[0];
                        return e(j(n.geometry.coordinates)), e(a(n.place_name, t))
                    }
                }))
            }
        }
        ...
        function R(t) {
            return function(e) {
                var n = "string" == typeof t ? t : t.join();
                return e(g("DESTINATION", !0)), e(d(n, function(t) {
                    if (e(g("DESTINATION", !1)), t.length) {
                        var n = t[0];
                        return e(T(n.geometry.coordinates)), e(u(n.place_name, t))
                    }
                }))
            }
        }
        ...
        function P(t, e) {
            return function(n, r) {
                var i = r(),
                    ...
                    a = i.waypoints,
                    u = i.profile;
                if (a.splice(t, 0, m(e)), s.geometry) {
                    var c = y(o, s, a);
                    n(h(c, u))
                }
                n(f(a))
    ...
    111: [function(t, e, n) {
        ...
        var o = "DESTINATION_INPUT";
        n.DESTINATION_INPUT = o;
        var s = "DESTINATION_LOADING";
        n.DESTINATION_LOADING = s;
        var a = "DIRECTIONS";
        n.DIRECTIONS = a;
        var u = "DIRECTIONS_PROFILE";
        n.DIRECTIONS_PROFILE = u;
        var c = "EVENTS";
        n.EVENTS = c;
        var f = "ERROR";
        n.ERROR = f;
        ...
        var o = t("lodash.template"),
            ...
            h = function() {
                ...
                return t.prototype.animateToCoordinates = function(t, e) {
                    ...
                    var t = this,
                        e = this.actions,
                        n = e.queryOriginInput,
                        r = e.queryDestinationInput,
                        i = e.addOrigin,
                        o = e.addDestination,
                        s = e.clearOrigin,
                    ...
                    this.originInput = this.container.querySelector(".js-origin"), this.destinationInput = this.container.querySelector(".js-destination"), this.originClear = this.container.querySelector(".js-origin-clear"), this.destinationClear = this.container.querySelector(".js-destination-clear"), this.originLoading = this.container.querySelector(".js-origin-loading"), this.destinationLoading = this.container.querySelector(".js-destination-loading"), this.originInput.addEventListener("keypress", u["default"](function(t) {
                        n(t.target.value)
                    }), 100), this.originInput.addEventListener("change", function() {
                        ...
                        r(t.target.value)
                    }), 100), this.destinationInput.addEventListener("change", function() {
                    ...
                    this.store.subscribe(function() {
                        var e = t.store.getState(),
                            ...
                            r = e.originLoading,
                            i = e.originResults,
                            o = e.destinationQuery,
                            s = e.destinationLoading,
                            a = e.destinationResults;
                ...
                return t.prototype.render = function() {
                    ...
                    this.store.subscribe(function() {
                        var e = t.actions,
                            ...
                            u = i.directions,
                            p = i.error,
                            d = !c["default"](u[s], t.directions);
                        if (p) return void(t.container.innerHTML = l({
                            error: p
                        }));
                        if (u.length && d) {
                            ...
                            Array.prototype.forEach.call(y, function(e) {
                                var r = e.getAttribute("data-lng"),
                                    i = e.getAttribute("data-lat");
    ...
    114: [function(t, e, n) {
        ...
        var a = t("redux"),
            ...
            h = t("./actions"),
            y = r(h),
            m = t("./directions_style"),
            g = i(m),
            v = t("./controls/inputs"),
            b = i(v),
            _ = t("./controls/instructions"),
            w = i(_),
            x = a.applyMiddleware(c["default"])(a.createStore),
            E = x(d["default"]),
            j = function(t) {
                function e(n) {
                ...
                return s(e, t), e.prototype.onAdd = function(t) {
                    ...
                    var t = this,
                        e = E.getState(),
                        n = e.profile;
                    this.actions.eventEmit("directions.profile", {
                        profile: n
                    });
                    var r = this.map,
                        i = new mapboxgl.GeoJSONSource({
                            data: {
                                type: "FeatureCollection",
                                features: []
                            }
                    ...
                    r.addSource("directions", i), g["default"].forEach(function(t) {
                        ...
                        i.geometry ? r.featuresAt(e.point, {
                            ...
                            } else t.actions.queryDestination(o), t.map.flyTo({
                                center: o
                            })
                        }) : t.actions.queryOrigin(o)
                    }.bind(this))
                    ...
                    E.subscribe(function() {
                        ...
                        o.length && o.forEach(function(t, e) {
                            var n = {
                                geometry: {
                                    type: "LineString",
                                    coordinates: f.decode(t.geometry, 6).map(function(t) {
                                        return t.reverse()
                                    })
                                },
                                properties: {
                                    "route-index": e,
                                    route: e === s ? "selected" : "alternate"
                                }
                            };
                    ...
                    if (this.dragging) {
                        ...
                        var e = this.map.unproject(this.mousePos(t)),
                            n = [e.lng, e.lat];
                        switch (this.dragging.layer.id) {
                            case "directions-origin-point":
                                this.actions.addOrigin(n);
                                break;
                            case "directions-destination-point":
                                this.actions.addDestination(n);
                                break;
                    ...
                    if (this.dragging) switch (this.dragging.layer.id) {
                        case "directions-origin-point":
                            this.actions.queryOrigin(n.geometry.coordinates);
                            break;
                        case "directions-destination-point":
                            this.actions.queryDestination(r.geometry.coordinates);
                            break;
                        case "directions-hover-point":
        ...
        "./actions": 110,
        "./controls/inputs": 112,
        "./controls/instructions": 113,
        "./directions_style": 115,
        "./reducers": 116,
        "./utils": 117,
        polyline: 93,
        redux: 96,
        ...
        function i(t, e) {
            switch (void 0 === t && (t = u), e.type) {
                ...
                case a.ORIGIN_INPUT:
                    return o({}, t, {
                        originQuery: e.query,
                        originResults: e.results
                    });
                case a.DESTINATION_INPUT:
                    return o({}, t, {
                        destinationQuery: e.query,
                        destinationResults: e.results
                    });
                case a.ORIGIN_CLEAR:
                    return o({}, t, {
                        origin: {},
                ...
                case a.ORIGIN_LOADING:
                    return o({}, t, {
                        originLoading: e.loading
                    });
                case a.DESTINATION_LOADING:
                    return o({}, t, {
                        destinationLoading: e.loading
                    });
                case a.REVERSE_INPUTS:
                    return o({}, t, {
                        origin: e.origin,
                        originResults: t.destinationResults,
                        originQuery: t.destinationQuery,
                        destination: e.destination,
                        destinationResults: t.originResults,
                        destinationQuery: t.originQuery
                    });
                case a.DIRECTIONS:
                    return o({}, t, {
